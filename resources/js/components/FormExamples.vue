        ...
        <form class="form-horizontal">
          ...
          <div class="form-group row">
            <label class="col-sm-3 form-control-label"
              >Checkboxes &amp; radios <br /><small class="text-primary"
            ...
            <div class="col-sm-9">
              <div class="i-checks">
                ...
                />
                <label for="checkboxCustom1">Checkbox</label>
              </div>
              <div class="i-checks">
                <input
                  id="radioCustom1"
                ...
                />
                <label for="radioCustom1">Radio</label>
              </div>
            </div>
          </div>
          <div class="line"></div>
            ...
            <div class="col-sm-9">
              ...
              <div class="form-group-material">
                <input
                  ...
                  class="input-material"
                />
                <label for="register-email" class="label-material"
                  >Email Address
                </label>
              </div>
              <div class="form-group-material">
                <input
                  ...
                  class="input-material"
                />
                <label for="register-password" class="label-material"
                  >Password
                </label>
              </div>
            </div>
